      ...
      <div className="min-h-screen bg-linear-0 from-black to-red-900/50 bg-black">
        ...
        <div className="p-4 max-w-md mx-auto">
          <div className="flex mb-4">
            ...
            />
            <button
              className="flex items-center px-4 text-cyan-300 font-semibold border-1 ring-2 ring-cyan-300/50  border-cyan-300 rounded hover:outline-1 hover:scale-95 transition-transform duration-100 cursor-pointer"
              type="button"
              title="Add"
              onClick={addTask}
            >
          ...
          <div>
            <ul className="space-y-2">
              {task.map((item, index) => (
                <li
                  key={index}
                  className="flex justify-between items-center p-2 rounded border-1 border-red-500 text-cyan-300"
                >
                  <label className="space-x-4 w-full flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={item.done}
                  ...
                  <div className="grid grid-cols-2 ml-2 space-x-4">
                    {editingIndex === index ? (
                      <button
                        type="button"
                        title="Save"
                        className="text-red-500 text-xl hover:text-yellow-200 cursor-pointer"
